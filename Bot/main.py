...
class VKBot:
    ...
    def name(self, user_id):
        """получить имя пользователя, кто написал боту"""
    ...
    def get_sex(self, user_id):
        """получение пола пользователя, меняет на другой"""
        url = f'https://api.vk.com/method/users.get'
        params = {'access_token': user_token,
                  'user_ids': user_id,
                  'fields': 'sex',
    ...
    def get_age_low(self, user_id):
        """получение возраста, не меньше которого искать"""
    ...
    def get_age_high(self, user_id):
        """получение возраста, максимальный возраст"""
        url = url = f'https://api.vk.com/method/users.get'
        params = {'access_token': user_token,
                  'user_ids': user_id,
                  'fields': 'bdate',
    ...
    def cities(self, user_id, city_name):
        """получение города пользователя ид по названию"""
